...
public class LogFilter implements Filter {
	...
	/* HttpServletRequest는 ServletRequest 인터페이스의 상위인터페이스이다.
	 * 상위 인터페이스인 HttpServletRequest에 있는 메소드를 사용하기 위해서 형변환 하여 사용한다. */
	...
	private String getCurrentTime() {
		/* DateFormat클래스는 추상클래스이며 SimpleDateFormat클래스가 상속받고 있다. */
