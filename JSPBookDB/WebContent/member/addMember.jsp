...
<body>
	...
	<div class="container">
	<%-- HTML 내에서 form 전송을 하기전에 입력된 데이터의 유효성을 체크하기 위해서 onsubmit 이벤트를 사용
		주의할점은 자바스크립트 함수명 앞에 return을 작성해야 자바스크립트의 리턴값이 form에 전달된다. --%>
		<form name="newMember" class="form-horizontal"	action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" name="bithyy" maxlength="4" placeholder="년(4자)" size="6" />
					<select name="bithmm">
					...
					<input type="text" name="bithdd" maxlength="2" placeholder="일" size="4"/>
				</div>
			</div>
			<div class="form-group row">
